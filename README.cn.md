...
[![x-cmd/install — jnv Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/jnv.svg?lang=zh)](https://x-cmd.com/install/jnv)
...
合计: **2,031** 行代码（覆盖前 5 种语言、共 **23** 个文件）。
...
- **最新版本**: `v0.7.1` (2026-04-01)
- **最近提交**: 2026-09-24
- **Release 含资产**: 20 个

## 流行度

- **Star**: 6,117 · **Fork**: 76 · **开放 issue**: 54 · **贡献者**: 14

## 累计统计

- **发布数**: 18 · **已合并 PR**: 54 · **开放 PR**: 11 · **已关闭 issue**: 33 · **开放 issue**: 21 · **提交数**: 379

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-27 | 0 | 1 | 1 | 0 | 0 | 2 |
| last60d | 2026-07-28 | 0 | 2 | 2 | 0 | 0 | 3 |
| 90d | 2026-06-28 | 0 | 2 | 2 | 0 | 0 | 4 |
| last180d | 2026-03-30 | 1 | 3 | 11 | 2 | 1 | 4 |
| 360d | 2025-10-01 | 3 | 11 | 11 | 4 | 2 | 122 |
| last720d | 2024-10-06 | 7 | 29 | 11 | 12 | 13 | 264 |
...
jnv 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `jnv` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/jnv.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260926.yml` · 2026-09-26T03:23:43Z._
